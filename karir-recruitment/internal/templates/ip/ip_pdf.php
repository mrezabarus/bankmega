...
//			$this->Cell(60,6,"Nama Calon Pegawai",1,0,'L',0);
			...
			$this->Cell(60,15,"Wawancara User",1,0,'L',0);
			//$this->MultiCell(120,$rowspan,"$interview",1,"L",0);
			$this->MultiCell(0,5,"$interview",1,"L",0);
			//$this->Cell(0,6,"Wawancara HRD	: $notes",1,1,'L',0);


			$this->Cell(60,20,"Wawancara HRD",1,0,'L',0);
			//$this->MultiCell(120,$rowspan,"$interview",1,"L",0);
			$this->MultiCell(0,5,"$notes",1,"L",0);
			//$this->Cell(0,6,"Wawancara HRD	: $notes",1,1,'L',0);
