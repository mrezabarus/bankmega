...
<table border="1" width="38%" bgcolor="#006699" cellpadding="2" bordercolor="#FFFFFF">
  <tr>
    <td width="100%" align="center"><font color="#FFFFFF"><b>Employee Report</b></font></td>
  </tr>
  <tr>
...
<form name=frmsql method=post action="templates/report/report_employee_pdf.php" target="WindowName">
