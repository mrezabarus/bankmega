...
$record_sql_syntax="[record_sql_syntax]";
$record_primary="[record_primary]";
$record_col="[record_col]";
$record_coltype="[record_coltype]";
$record_directcol="[record_coltype]";
$record_searchby="[record_searchby]";
$record_sortby="[record_sortby]";
$record_fieldtype="[record_fieldtype]";
$record_fieldform="[record_fieldform]";
                          ...
                          <TR>
                            <TD class=heading2>
                              <TABLE class=heading2 cellSpacing=1 cellPadding=1 width="100%" align=center border=0>
                                ...
                                <TR>
                                <TD style="HEIGHT: 1px">
									<IMG height=1 src="<?=$ANOM_VARS["www_url"]?>images/spotw.gif" width="100%"></TD></TR></TABLE></TD></TR>
							...
							<form name="frmnew" action="<?=getenv("SCRIPT_NAME")?>?<? if(isset($_GET["url_id"])){echo "url_id=" . $_GET["url_id"] . "&";}?>record_id=<?=uriParam("record_id")?>&save=yes" method="post">
                                ...
                                <TR>
                                <TD style="HEIGHT: 1px" colSpan=3><IMG height=1 src="<?=$ANOM_VARS["www_url"]?>images/spotw.gif" width="100%" name=zgif2></TD></TR></TABLE></TD>
                                ...
                                <TD style="HEIGHT: 1px" colSpan=3>
									<IMG height=1 src="<?=$ANOM_VARS["www_url"]?>images/spotw.gif" width="100%" name=zgif2></TD></TR></TABLE></TD>
                                ...
                                <TD class=tablefooter noWrap></TD></TR></TABLE></TD></TR>
                                <TR>
								<!--- End Of Page Counter --->
								</form>
                                <TD style="HEIGHT: 1px" colSpan=3><IMG height=1 
                                src="<?=$ANOM_VARS["www_url"]?>images/spotw.gif" width="100%" 
                                name=zgif2></TD></TR></TABLE></TD></TR></TABLE></TD></TR></TABLE></TD></TR></TABLE></FORM>
