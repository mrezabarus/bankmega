...
function recordlist($record_id){
	require_once('template_recordlist/recordlist_'.trim($record_id).'.php');
}

function recordlist_preview($record_id){
...
<!--- Start Main Workflow --->
<TABLE style="HEIGHT: 148" cellSpacing=0 cellPadding=0 width="101%" border=0>
  <TR>
