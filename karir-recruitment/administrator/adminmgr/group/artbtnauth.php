...
<html>
<head>
	<title>devSite Builder - Button Authorization</title>
	...
	<script>
		function getAuth(){
			...
			if(arrCheck.length != null){
				eval("opener.frmedit.btn_"+opener.temptype+"_"+opener.sel).value = arrCheck.join(",");
				opener.moveValue();
			}
			self.close();
		}
	...
	<tr>
		<td>
			<table border="0" cellpadding="2" cellspacing="0" width="100%">
				<tr>
					<td width="1%"><input type="Checkbox" class="text" name="cAuth" value="ADD"></td>
					<td width="99%">ADD</td>
				</tr>
				<tr>
