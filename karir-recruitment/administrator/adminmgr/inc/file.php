	...
	<script language="JScript" for="OK" event="onclick">
	  var arr = new Array();
		if (deleteSpaces(iURL.value) !="") {
		  window.returnValue = "<a href=\""+iURL.value+"\""+(deleteSpaces(iDesc.value) !=""?" title=\""+iDesc.value+"\"":"")+">"+(deleteSpaces(iDesc.value)!=""?iDesc.value:iURL.value)+"</a>";
		  window.close();
...
<div id="state_1" style="border:1px inset;margin:2px;width:523px;height:228px;overflow-x:hidden;overflow-y:hidden">
	<table cellpadding="0" cellspacing="2" border="0" style="margin:3px">
		<tr>
			<td colspan="2">
				<table cellspacing="0" cellpadding="0" border="0">
					<tr>
						<td valign="top"><fieldset style="margin:3px"><legend>File Object Browser</legend>
							<iframe name="imgBrowser" style="margin:4px;width:493px;height:138px;" src="filebrowser.php?SEED=<?=urlencode(date("mdYhis"))?>"></iframe>
						</fieldset></td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td>
				<table cellpadding="0" cellspacing="1" border="0">
					<tr>
						<td>URL&nbsp;&nbsp;</td>
						<td><input name="iURL" type="text" class="itext" style="width:432px" value=""></td>
					</tr>
					<tr>
						<td>Description&nbsp;&nbsp;</td>
						<td><input name="iDesc" type="text" class="itext" style="width:432px" value=""></td>
					</tr>
				</table>
			</td>
		</tr>
...
<div id="state_2" style="visbility:hidden;display:none;width:300px;height:232px;">
	<iframe name="imgBrowser" style="margin:4px;width:519px;height:224px;" src="_flmng/index.php"></iframe>
</div>
</fieldset>
