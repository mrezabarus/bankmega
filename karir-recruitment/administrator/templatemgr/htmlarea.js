...
HTMLArea.Config = function () {
	...
	this.btnList = {
		...
		insertcomponent: [ "Article Component", "customtag.gif", false, function(e) {e.execCommand("insertcomponent");} ],
		sqlwizard: [ "Shared Template Part", "ed_copy2.gif", false, function(e) {e.execCommand("sqlwizard");} ]
	};
...
// Called when the user clicks on "InsertComponent" button.
HTMLArea.prototype._insertComponent = function(image) {
	var editor = this;	// for nested functions
	var outparam = null;
	var sel = this._getSelection();
	var range = this._createRange(sel);
	var editor = this;	// for nested functions
	this._popupDialog("insert_component.php", function(param) {
		...
		if (HTMLArea.is_ie) {
			range.pasteHTML(param["f_alt"]);
		} else {
			// insert the table
			editor.insertNodeAtSelection(param["f_alt"]);
		}
...
// Called when the user clicks on "sqlwizard" button.
HTMLArea.prototype._sqlWizard = function(image) {
	var editor = this;	// for nested functions
	var outparam = null;
	var sel = this._getSelection();
	var range = this._createRange(sel);
	var editor = this;	// for nested functions
	this._popupDialog("insert_templatepart.php", function(param) {
...
// Called when the user clicks on "dhtmlmenu" button.
HTMLArea.prototype._dhtmlMenu = function(image) {
	var editor = this;	// for nested functions
	var outparam = null;
	var sel = this._getSelection();
	var range = this._createRange(sel);
	var editor = this;	// for nested functions
	this._popupDialog("insert_menu.php", function(param) {
...
// Called when the user clicks on "Recordlist" button.
HTMLArea.prototype._recordlist = function(image) {
	var editor = this;	// for nested functions
	var outparam = null;
	var sel = this._getSelection();
	var range = this._createRange(sel);
	var editor = this;	// for nested functions
	this._popupDialog("insert_recordlist.php", function(param) {
...
HTMLArea.prototype.execCommand = function(cmdID, UI, param) {
	...
	switch (cmdID) {
		...
		case "insertcomponent": this._insertComponent(); break;
		case "insertfunction": this._insertFunction(); break;
		case "sqlwizard": this._sqlWizard(); break;
		case "dhtmlmenu": this._dhtmlMenu(); break;
		case "recordlist": this._recordlist(); break;
