...
**********************************************************************************************************************************************/
	...
	var StaticPos=0;
	var LftXtra=DomNav?RightPaddng:0;
...
function RePos(){
	...
	if(MenuCentered=='justify'&&FirstLineHorizontal){
		...
		ClcJus();
		var P=FrstCntnr.FrstMbr,W=Menu1[6],i;
...
function NavMbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
	...
	if(RightPaddng&&this.value.indexOf('<')==-1&&MenuTextCentered=='left')this.value='&nbsp\;'+this.value;
