...
<div class="title">Insert SQL Syntax</div>
<!--- new stuff --->
<?
	$function_db = cmsDB();
	$strSQL = "select * from tbl_sql";
...
<table border="0" width="100%" style="padding: 0px; margin: 0px">
  <tbody>
  <tr>
    <td style="width: 15em; text-align: right">Syntax Name:</td>
    <td>
	<select name="alt" id="f_alt">
	<?
		while ($function_db->next()) {
			echo "<option value='" . $function_db->row("sql_code") . "'>" . $function_db->row("sql_name") . "</option>";
		}
	?>
	</select>
