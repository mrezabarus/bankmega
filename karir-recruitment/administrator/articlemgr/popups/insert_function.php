...
<div class="title">Insert Function</div>
<!--- new stuff --->
<?
	$function_db = cmsDB();
	$strSQL = "select * from afs_function";
...
<table border="0" width="100%" style="padding: 0px; margin: 0px">
  <tbody>
  <tr>
    <td style="width: 15em; text-align: right">Function Name:</td>
    <td>
	<select name="alt" id="f_alt">
	<?
		while ($function_db->next()) {
			echo "<option value='" . $function_db->row("function_code") . "'>" . $function_db->row("function_name") . "</option>";
		}
	?>
	</select>
