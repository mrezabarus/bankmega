<?
	require ("../config.php");
	$instance = uriParam("instance",1);
	$src = uriParam("src","");
	$alt = uriParam("alt","");
	$height = uriParam("height","");
	$width = uriParam("width","");
	$hspace = uriParam("hspace","");
	$vspace = uriParam("vspace","");
	$align = uriParam("align","");
	$border = uriParam("border","");
	$style = uriParam("style","");
	$type = uriParam("type",1);
