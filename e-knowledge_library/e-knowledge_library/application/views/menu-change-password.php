  ...
  <body>
	...
	<div class="sambutan">
	  <div class="container">
		...
		<h1 class="nama">Change Password</h1>
		<p class="about1"><span class="about2">Untuk mengubah sandi Akun Anda, atau Anda dapat mengikuti langkah-langkah di bawah ini:</span></p>
		</br>
		</br>
	  </div>
	</div>
      ...
      <div class="row">
		...
		<?php 
			if( $ChangePassword == 'true' ){
				echo '<h3 class="padding7 btn-success">Change password has been success</h3>';
				echo '<p class="">Klik <a href="'. base_url() .'index.php/welcome">Home</a> untuk melanjutkan.</p>';
				
			}
			else{
				$this->load->view('menu-change-password-form');
			}
		?>
