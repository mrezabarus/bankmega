  ...
  <body>
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <?php 
			if(!empty($_SESSION['lbrary_nip'])){
				/* display for after signin */
				$this->load->view('navbar_sigin_ok');
			}	
			else{
				$this->load->view('navbar_sigin');
			}			
		  ?>
        </div><!-- /.nav-collapse -->
      </div><!-- /.container -->
	...
	<div class="sambutan">
	  <div class="container">
		<?php 
		  if($signSts===false){
			echo '<h3 class="padding7 btn-danger">Oops.. sorry user name or password invalid.</h3>';
		  }
		  else{
			echo '<br/>';
		  }
		...
		?></h1>
          <?php 
			if(!empty($_SESSION['lbrary_nip'])){
				echo '
				<p>Selamat datang di e-knowledge library, Human Capital Management (HCMG), PT. BANK MEGA Tbk.   Silahkan mengunakan fasilitas e-knowledge kami. Terima kasih.</p>
				';
			}	
			else{
				echo '
				<p>Selamat datang di e-knowledge library, Human Capital Management (HCMG), PT. BANK MEGA Tbk.   Silahkan signin untuk dapat mengunakan fasilitas kami. Terima kasih.</p>
				';
			}			
		  ?>		
		</br>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          <div class="list-group">
			...
			<div class="row">
			  <div class="col-xs-12 col-md-12" id="advert">
				  <iframe class="col-xs-12 col-md-12 img-thumbnail iframe" src="<?php echo base_url(); ?>advert/advert.html">
