  ...
  <body>
		...
		<div class="col-xs-12">
			<form class="form-horizontal" role="form" id="form1" name="form1" method="post" action="">
			  ...
			  <div class="form-group ">
				...
				<div class="col-sm-6">
				  <input type="text" class="form-control" name="nip" id="nip" placeholder="Input NIP/Nama">
				</div>
			  </div>		
			</form>
			</br>			
	...
	<script>
		$( "#nip" ).keyup(function() {
			...
			if(nip!=''){
				$('#receiver').show();
				//alert( "Handler for " + nip );
				var data = {
					nip:nip
				};
				var url = '<?php echo base_url(); ?>index.php/adminmax/eknowledgeUser';
		...
		function resetPwd(id){
			var r = confirm("Apakah anda yakin ingin mereset password " + id + "?");
			if (r == true) {
				$.post("<?php echo base_url(); ?>index.php/adminmax/resetPwd",
				{	
					nip: id	
				},
