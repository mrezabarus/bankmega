...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h4>View of <?php echo $attr['training'];?>, <?php echo $attr['tahun'];?> , peserta <?php echo $attr['tahun'];?> </h4>
		  
		  <p><a href="<?php echo base_url();?>assets/download/<?php echo $export['fileName'];?>?">Download excel file</a></p>
