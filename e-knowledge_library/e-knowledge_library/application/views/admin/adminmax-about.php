...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12">
		  <p class="rules">Sejak 2012 tim HCMG memanfaatkan pengetahuan yang luas dan keahlian dalam pengembangan aplikasi interaktif. Produk kami telah digunakan sebagai transfer pengetahuan tanpa terhalang jarak yang jauh, karena kami memanfaatkan teknologi dan infrastruktur yang telah ada. Dalam banyak hal dimungkinkan efisiensi waktu, tenaga dan biaya untuk produk yang telah kami buat. Kami sangat menghargai kualitas tinggi dari perkerjaan teman - teman dan saran untuk perbaikan yang berharga. Banyak manfaat yang diperoleh dan solusi baru untuk sistem eknowledge.</p>
		  </br>
