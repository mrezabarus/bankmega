...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h4>View of id jadwal <?php echo $findJadwal->id_jadwal;?>, <?php echo $findJadwal->kursus;?> , peserta <?php echo $findJadwal->peserta;?> </h4>
		  
		  <p><a href="<?php echo base_url();?>assets/download/<?php echo $CurveExport['fileName'];?>?">Download excel file</a></p>
		  
			<div class="col-xs-12">
			  <?php 
				  if(!empty($getDataChart)){
					echo '<div id="container" style="min-width: 310px; max-width: 800px; height: 500px; margin: 0 auto"></div>';
				  }
			  ?>
	...
	<script>
		$(function () {
			$('#container').highcharts({
				...
				title: {
					text: '<?php echo $SetData['title']; ?>'
				},
				subtitle: {
					text: '<?php echo $SetData['subtitle']; ?>'
				},
				xAxis: {
					// categories: ['Jakarta', 'Bandung', 'Semarang', 'Surabaya', 'Makassar'],
					categories: [<?php echo $SetData['categories']; ?>],
					title: {
						text: null
					}
				},
	...
	/* 				layout: 'vertical',
				...
				series: [{
					name: 'Register',
					data: [<?php echo $SetData['register']; ?>]
				}, {
					name: 'UnLogin',
					data: [<?php echo $SetData['unlogin']; ?>]
				},{
					name: 'UnPass',
					data: [<?php echo $SetData['unpass']; ?>]
				},{
					name: 'Pass',
					data: [<?php echo $SetData['pass']; ?>]
				},{
					name: 'Certify',
					data: [<?php echo $SetData['certify']; ?>]
				} ]
			});
		});  
	</script>  
