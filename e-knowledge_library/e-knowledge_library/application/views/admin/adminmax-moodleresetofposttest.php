...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
	...
	$('input[name="nip"]').autocomplete({
		source: "<?php echo base_url(); ?>index.php/adminmax/ResetofPosttestMoodle",
		// minChars: 3,
		select: function( event, ui ) {
			...
			$('input[name="nip"]').val(decoded);
 			...
 			var url = "<?php echo base_url(); ?>index.php/adminmax/ResetofPosttestMoodle";
			var data = {
			  id:ui.item.value
			};
	...
	function resetPost(nip, scormid, scoid, attempt, id_kursus, max_scoid, max_attempt){
		var r = confirm("Apakah Anda yakin ingin mereset hasil test " + nip + "?");
		if (r == true) {
			$.post("<?php echo base_url(); ?>index.php/adminmax/ResetterOfNipMoodle",
			{	
				nip: nip,
				scormid: scormid,
				scoid: scoid,
	...
	function detail(id) {
		...
		var myWindow = window.open("http://172.29.119.99/bb_appl/pbl/pbl_detail_tag.php?nip="+id, "", "width=600, height=400");
	}	
