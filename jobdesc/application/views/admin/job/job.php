                        ...
                        <tbody>
                            ...
                            <?php foreach($listjob as $e): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url();?>index.php/admin/job/view/<?php echo $e->id_job;?>"><i class="fas fa-binoculars"></i></a>
                                        <a href="<?php echo base_url();?>index.php/admin/job/add/<?php echo $e->id_job;?>"><i class="fas fa-plus"></i></a></i></a>
