    ...
    <div class="row">
        <div class="col-sm-9 col-md-7 col-lg-8">
            ...
            <div class="card card-signin my-5">
                <h5 class="card-header" style="background-color: #43425D; color:#fff;">Position List</h5>
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <?php foreach($listjob as $e): ?>
                            <tr>
                                ...
                                <td><a href="<?php echo base_url();?>index.php/job/review/<?php echo $e->job_id;?>" target="_blank"><i class="fas fa-binoculars">&nbsp;</i></a>&nbsp;|&nbsp;<a href="<?php echo base_url();?>index.php/job/add/<?php echo $e->job_id;?>"><i class="fas fa-edit">&nbsp;</i></a></td>
                            </tr>
                        <?php $a++; ?>
                        <?php endforeach; ?>
